...
if(isset($_POST['submit'])){
    ...
    $sql = "SELECT * FROM admin WHERE LOWER(name) = LOWER('$name') AND BINARY password = '$password'";
...
<body>
    ...
    <div class="main">
        ...
        <form class="form1" method="post">
            ...
            <p align=center class="role-msg">Are you a student? <a href="login_student.php" style="color:#2952a3;">Login Here</a></p>
    </div>
</body>
</html>